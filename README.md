...
* **AI:** `Gemini API`—integrated Google technology for partial searching
...
3. Browse results that include both exact matches, related products (e.g. searching "chicken" also returns "chicken cubes") and partial and typo-tolerant results (e.g. searching "chckn" still returns "chicken)
