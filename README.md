...
* **AI:** `Gemini API`-integrated Google technology for full-sentence queries.
...
3. Browse results that include both exact matches, related products (e.g. searching "chicken" also returns "chicken cubes"), and sentence queires (e.g. searching "where to buy egg?" still returns "egg").
